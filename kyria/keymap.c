 ...
 */
    [_NUM] = LAYOUT_split_3x6_5(
     ...
     XXXXXXX , KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_NUM_LOCK, _______, _______,     _______ ,TG(_CTL),MS_LEFT , MS_DOWN,  MS_UP , MS_RGHT, MS_WHLD,XXXXXXX ,
                                   TO(0), XXXXXXX, XXXXXXX    , _______, XXXXXXX,     XXXXXXX ,_______ ,MS_BTN1 , MS_BTN2, MS_BTN3
    ),
 ...
 */
 ...
 LSFT(KC_GRV), KC_SLSH  ,LSFT(KC_8),  KC_MINS ,LSFT(KC_EQL),  KC_EQL  ,XXXXXXX ,_______ ,     _______ , _______  ,LSFT(KC_COMM),LSFT(KC_LBRC),  KC_LBRC ,  KC_RBRC ,LSFT(KC_RBRC), LSFT(KC_DOT),
                                         TO(0),     XXXXXXX,   XXXXXXX,_______ ,XXXXXXX ,     XXXXXXX , _______  ,      XXXXXXX,      XXXXXXX, XXXXXXX
    ),
 ...
 */
    [_CTL] = LAYOUT_split_3x6_5(
     ...
     KC_PAUSE, KC_PSCR ,   KC_SCRL ,   KC_INS , KC_NUM_LOCK,  RM_TOGG ,XXXXXXX ,XXXXXXX ,     XXXXXXX , TG(_CTL) ,     RM_PREV ,     RM_NEXT ,  RM_VALD ,  RM_VALU ,     RM_SPDD ,    RM_SPDU  ,
                                        TO(0) ,  XXXXXXX   ,  _______ ,XXXXXXX ,_______ ,     _______ , XXXXXXX  ,   _______   ,   XXXXXXX   ,   _______
    ),
 ...
 */
    [_PTG] = LAYOUT_split_3x6_5(
     ...
     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,      MS_BTN1 ,MS_BTN2 ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,XXXXXXX ,
